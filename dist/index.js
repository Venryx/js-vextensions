...
/***/ (function(module, exports) {
	...
	// ==========
	//(()=> {
	HTMLElement.prototype._AddGetter_Inline = function R() {
	    return g.FindReact(this);
	};
	//})();
...
/***/ (function(module, exports) {
	...
	g.Extend({ ToJSON_Safe: ToJSON_Safe });
	...
	g.Extend({ ToJSON_Try: ToJSON_Try });
	function ToJSON_Try() {
	    try {
	        for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
	            args[_key3] = arguments[_key3];
	...
	function GetTreeNodesInPath(treeRoot, pathNodesOrStr) {
	    ...
	    if (descendantPathNodes.length > 1) result.push.apply(result, _toConsumableArray(GetTreeNodesInPath(childTreeNode ? childTreeNode.Value : null, descendantPathNodes.Skip(1).join("/"), false, _ancestorNodes.concat(childTreeNode))));
	    return result;
	}
	...
	function VisitTreeNodesInPath(treeRoot, pathNodesOrStr, visitFunc) {
	    ...
	    if (descendantPathNodes.length > 1) VisitTreeNodesInPath(childTreeNode.Value, descendantPathNodes.Skip(1).join("/"), visitFunc, false, _ancestorNodes.concat(childTreeNode));
	    return treeRoot;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _JSVE = __webpack_require__(10);
	...
	g.Extend({ A: A, A_NotEqualTo_Wrapper: A_NotEqualTo_Wrapper, A_OfType_Wrapper: A_OfType_Wrapper });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	g.Extend({ TryCall: TryCall, TryCall_OnX: TryCall_OnX });
	g.Extend({ WaitXThenRun: WaitXThenRun });
	...
	var URL = exports.URL = function () {
	    _createClass(URL, [{
	        ...
	        value: function FromState(state) {
	            var result = URL.Parse(state ? (state.pathname || "") + (state.search || "") + (state.hash || "") : "");
	    ...
	    _createClass(URL, [{
	        ...
	        key: "Clone",
	        value: function Clone() {
	            return new URL(this.domain, this.pathNodes.slice(), this.queryVars.map(function (a) {
	                return a.Clone();
	            }), this.hash);
	        }
	        /*Normalized() {
